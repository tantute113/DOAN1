...
<?php 
 if(isset($_POST['submit'])){
  if(isset($_POST['tendanhmuc'])&&!empty($_POST['tendanhmuc']))
  {
   ...
   $rrrt=themdanhmuc($tendanhmuc,$noidungdm,$conn);
 ...
 ?>
   ...
   <div class="edit-ad">
   <div class="name-ed-ad"> <h2><h2><a href="./index-ad.php?action=danhmuc"><i style="color: white;" class="fas fa-sign-out-alt"></i></a>Thêm danh mục</h2></div>
  ...
  <div class="input-ad">
    <div class="label-ad">
       ...
       <label  >Nội dung danh mục</label>
        ...
        <textarea id="text2" name="noidungdanhmuc" id="product-content" cols="100" rows="40" ></textarea>
        </div>
